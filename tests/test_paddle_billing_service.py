...
async def test_paddle_portal_session_omits_return_url_and_parses_overview() -> None:
    ...
    route = respx.post("https://sandbox-api.paddle.com/customers/ctm_portal/portal-sessions").mock(
        return_value=Response(
            200,
            json={
                "data": {
...
async def test_paddle_portal_session_without_subscription_sends_empty_body() -> None:
    ...
    route = respx.post("https://sandbox-api.paddle.com/customers/ctm_only/portal-sessions").mock(
        return_value=Response(
            200,
            json={
                "data": {
