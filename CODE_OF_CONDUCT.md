...
This project is founder-led (see `GOVERNANCE.md`) — there is no
separate moderation team today. Guruprasath Annadurai is responsible
for clarifying and enforcing these standards, and will take
appropriate and fair corrective action in response to any behavior
deemed inappropriate, threatening, offensive, or harmful.

## Scope

This Code of Conduct applies within all project spaces (this
...
may be reported to **annaduraiguruprasath7@gmail.com**. All complaints will
