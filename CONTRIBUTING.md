...
`src/responsibleai/mcp/metadata.py` for production tool counts).
...
source-code or private hosted access through that program. Issue #90 remains
closed for historical source-access requests; do not reopen that form.
