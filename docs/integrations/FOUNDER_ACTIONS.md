...
| Platform | Action | Why Claude can't do it | Evidence prepared | Next step |
|---|---|---|---|---|
| Claude | Add WhitePact as a custom connector via Settings → Connectors | Needs an interactive Claude session with your own account | Exact click-path in `claude.md` | Follow the steps, confirm 30 tools appear |
