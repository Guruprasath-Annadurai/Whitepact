...
class DisclosureClass(StrEnum):
    ...
    PRIVILEGED_AUDIT_VIEW = "PRIVILEGED_AUDIT_VIEW"
    NEVER_PUBLIC = "NEVER_PUBLIC"


class ClaimType(StrEnum):
    """Claim categories for claim-specific source authority."""

    LEGAL_ENTITY_EXISTENCE = "LEGAL_ENTITY_EXISTENCE"
    LEGAL_ENTITY_STATUS = "LEGAL_ENTITY_STATUS"
    CURRENT_EMPLOYMENT = "CURRENT_EMPLOYMENT"
    CURRENT_ORGANIZATION_ROLE = "CURRENT_ORGANIZATION_ROLE"
    CURRENT_DELEGATED_AUTHORITY = "CURRENT_DELEGATED_AUTHORITY"
    ...
    PUBLIC_PROFESSIONAL_ASSERTION = "PUBLIC_PROFESSIONAL_ASSERTION"
