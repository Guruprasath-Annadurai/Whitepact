...
TABLE_CLASSIFICATIONS: dict[str, TableClassification] = {
    ...
    "governance_execution_authorizations": TableClassification("governance_execution_authorizations", DataClassification.CANONICAL_SECURITY_EVIDENCE, SensitivityTier.CRITICAL, "SECURITY_EVIDENCE_DEFAULT", False, False),
    ...
    "runtime_execution_attempts": TableClassification("runtime_execution_attempts", DataClassification.CANONICAL_SECURITY_EVIDENCE, SensitivityTier.CRITICAL, "SECURITY_EVIDENCE_DEFAULT", False, False),
    "runtime_execution_dispatch_outbox": TableClassification("runtime_execution_dispatch_outbox", DataClassification.SENSITIVE_SECURITY, SensitivityTier.HIGH, "ACTIVE_LIFETIME", False, False),
    "runtime_execution_fences": TableClassification("runtime_execution_fences", DataClassification.CANONICAL_SECURITY_EVIDENCE, SensitivityTier.CRITICAL, "SECURITY_EVIDENCE_DEFAULT", False, False),
    "runtime_execution_requests": TableClassification("runtime_execution_requests", DataClassification.CANONICAL_SECURITY_EVIDENCE, SensitivityTier.CRITICAL, "SECURITY_EVIDENCE_DEFAULT", False, False),
    "runtime_worker_leases": TableClassification("runtime_worker_leases", DataClassification.SENSITIVE_SECURITY, SensitivityTier.HIGH, "ACTIVE_LIFETIME", False, False),
    ...
    "enterprise_environments": TableClassification("enterprise_environments", DataClassification.TENANT_OPERATIONAL, SensitivityTier.HIGH, "ACTIVE_LIFETIME", True, True),
    "enterprise_service_accounts": TableClassification("enterprise_service_accounts", DataClassification.SENSITIVE_SECURITY, SensitivityTier.CRITICAL, "ACTIVE_LIFETIME", False, True),
    "enterprise_service_account_environments": TableClassification("enterprise_service_account_environments", DataClassification.SENSITIVE_SECURITY, SensitivityTier.HIGH, "ACTIVE_LIFETIME", False, True),
    "enterprise_security_audit": TableClassification("enterprise_security_audit", DataClassification.CANONICAL_SECURITY_EVIDENCE, SensitivityTier.CRITICAL, "SECURITY_EVIDENCE_DEFAULT", True, False),
    "api_key_issuance_decisions": TableClassification("api_key_issuance_decisions", DataClassification.CANONICAL_SECURITY_EVIDENCE, SensitivityTier.HIGH, "SECURITY_EVIDENCE_DEFAULT", True, False),
    "identity_verifications": TableClassification("identity_verifications", DataClassification.PERSONAL, SensitivityTier.CRITICAL, "ACCOUNT_LIFETIME", False, True),
    "organization_verifications": TableClassification("organization_verifications", DataClassification.SENSITIVE_SECURITY, SensitivityTier.CRITICAL, "ACCOUNT_LIFETIME", False, True),
    "identity_provider_events": TableClassification("identity_provider_events", DataClassification.SENSITIVE_SECURITY, SensitivityTier.HIGH, "SECURITY_EVIDENCE_DEFAULT", False, False),
    "webauthn_challenges": TableClassification("webauthn_challenges", DataClassification.SENSITIVE_SECURITY, SensitivityTier.HIGH, "SESSION_EXPIRY", False, True),
    "passkey_credentials": TableClassification("passkey_credentials", DataClassification.CREDENTIAL_SECRET, SensitivityTier.CRITICAL, "ACCOUNT_LIFETIME", False, True),
    "human_totp_factors": TableClassification("human_totp_factors", DataClassification.CREDENTIAL_SECRET, SensitivityTier.CRITICAL, "ACCOUNT_LIFETIME", False, True),
    "recovery_code_hashes": TableClassification("recovery_code_hashes", DataClassification.CREDENTIAL_SECRET, SensitivityTier.CRITICAL, "ACCOUNT_LIFETIME", False, True),
    "account_recovery_requests": TableClassification("account_recovery_requests", DataClassification.SENSITIVE_SECURITY, SensitivityTier.CRITICAL, "SESSION_EXPIRY", False, True),
    "provider_identities": TableClassification("provider_identities", DataClassification.PERSONAL, SensitivityTier.HIGH, "ACCOUNT_LIFETIME", False, True),
    "organization_idp_bindings": TableClassification("organization_idp_bindings", DataClassification.SENSITIVE_SECURITY, SensitivityTier.CRITICAL, "ACCOUNT_LIFETIME", False, True),
    "organization_sso_configs": TableClassification("organization_sso_configs", DataClassification.CREDENTIAL_SECRET, SensitivityTier.CRITICAL, "ACCOUNT_LIFETIME", False, True),
    "step_up_grants": TableClassification("step_up_grants", DataClassification.SENSITIVE_SECURITY, SensitivityTier.HIGH, "SESSION_EXPIRY", False, True),
    "auth_replay_records": TableClassification("auth_replay_records", DataClassification.CANONICAL_SECURITY_EVIDENCE, SensitivityTier.HIGH, "SECURITY_EVIDENCE_DEFAULT", False, False),
