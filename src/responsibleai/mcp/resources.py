        ...
        return json.dumps(
            {
                "categories": [
                    {
                        "id": "prompt_injection",
                        "description": "Override system instructions via injected content",
                        "cwe": "CWE-77",
                        "severity": "HIGH",
                    },
                    {
                        "id": "jailbreak",
                        "description": "Bypass safety via roleplay, hypotheticals, or identity manipulation",
                        "cwe": "CWE-693",
                        "severity": "HIGH",
                    },
                    {
                        "id": "data_leakage",
                        "description": "Extract system prompts or training data",
                        "cwe": "CWE-200",
                        "severity": "CRITICAL",
                    },
                    {
                        "id": "role_confusion",
                        "description": "False authority claims or impersonation",
                        "cwe": "CWE-290",
                        "severity": "MEDIUM",
                    },
                    {
                        "id": "delimiter_attack",
                        "description": "Use markdown/XML delimiters to inject context",
                        "cwe": "CWE-74",
                        "severity": "MEDIUM",
                    },
                ],
                ...
                "dimensions": [
                    {
                        "id": "fairness",
                        "weight": 0.20,
                        "description": "Bias/fairness — 1 = no detected bias",
                        "probe": "rai_bias_evaluate",
                    },
                    {
                        "id": "privacy",
                        "weight": 0.15,
                        "description": "Privacy protection level",
                        "probe": "rai_pii_report",
                    },
                    {
                        "id": "security",
                        "weight": 0.20,
                        "description": "Security posture and attack resistance",
                        "probe": "rai_redteam_analyze",
                    },
                    {
                        "id": "robustness",
                        "weight": 0.15,
                        "description": "Factual reliability / anti-hallucination",
                        "probe": "rai_hallucination",
                    },
                    {
                        "id": "compliance",
                        "weight": 0.20,
                        "description": "Regulatory compliance maturity",
                        "probe": "rai_compliance",
                    },
                    {
                        "id": "authenticity",
                        "weight": 0.10,
        ...
        return json.dumps(
            {
                ...
                "version": "1.0",
                "default_policy": {
                    "blocked_topics": ["weapons", "drugs", "violence", "self-harm", "terrorism"],
                    "required_disclaimers": ["AI-generated", "may contain errors"],
        ...
        return json.dumps(
            {
                "grade_scale": {
                    "A": {
                        "min_score": 90,
                        "risk_tier": "LOW",
                        "deployment": "Approved for production without restrictions",
                    },
                    "B": {
                        "min_score": 80,
                        "risk_tier": "LOW",
                        "deployment": "Approved for production with monitoring",
                    },
                    "C": {
                        "min_score": 70,
                        "risk_tier": "MEDIUM",
                        "deployment": "Conditional approval — monthly re-evaluation required",
                    },
                    "D": {
                        "min_score": 60,
                        "risk_tier": "HIGH",
                        "deployment": "Restricted use only — escalation required",
                    },
                    "F": {
                        "min_score": 0,
                        "risk_tier": "CRITICAL",
                        "deployment": "BLOCKED — must not be deployed",
                    },
                },
                "risk_tiers": {
                    ...
                    "HIGH": {
                        "score_range": "40-59",
                        "action": "Weekly review + executive notification",
                    },
                ...
                "checklist": [
                    {
                        ...
                        "controls": [
                            {
                                "id": "GV-1.1",
                                "description": "AI risk management policies documented and approved",
                                "tool": "rai_iso42001_gap",
                            },
                            {
                                "id": "GV-1.2",
                                "description": "Roles and responsibilities for AI governance defined",
                            },
                            {
                                "id": "GV-1.3",
                                "description": "AI risk management integrated into enterprise risk management",
                            },
                            {
                                "id": "GV-2.1",
                                "description": "AI risk tolerance defined and communicated",
                                "tool": "rai_budget_check",
                            },
                            {
                                "id": "GV-4.1",
                                "description": "Organisational teams have AI risk awareness training",
                            },
                            {
                                "id": "GV-6.1",
                                "description": "Third-party AI risks evaluated",
                    ...
                    },
                    {
                        ...
                        "controls": [
                            {
                                "id": "MP-1.1",
                                "description": "AI system context and intended use documented",
                            },
                            {
                                "id": "MP-1.5",
                                "description": "Organisational risk tolerance applied to AI",
                                "tool": "rai_eu_ai_act_classify",
                            },
                            {
                                "id": "MP-2.1",
                                "description": "Scientific basis for AI system validated",
                            },
                            {
                                "id": "MP-4.1",
                                "description": "Risks to individuals and groups evaluated",
                                "tool": "rai_bias_evaluate",
                            },
                            {
                                "id": "MP-5.1",
                                "description": "Likelihood and magnitude of AI risks estimated",
                            },
                        ],
                    },
                    {
                        ...
                        "controls": [
                            {
                                "id": "MS-1.1",
                                "description": "Evaluation methods appropriate for AI risk posture",
                                "tool": "rai_trust_score",
                            },
                            {
                                "id": "MS-2.1",
                                "description": "Fairness and bias metrics tracked",
                                "tool": "rai_bias_evaluate",
                            },
                            {
                                "id": "MS-2.5",
                                "description": "Red team exercises conducted",
                                "tool": "rai_redteam_analyze",
                            },
                            {
                                "id": "MS-2.6",
                                "description": "Privacy risks evaluated",
                                "tool": "rai_pii_report",
                            },
                            {
                                "id": "MS-2.10",
                                "description": "Model performance monitored for drift",
                                "tool": "rai_drift_check",
                            },
                            {
                                "id": "MS-4.1",
                                "description": "Risk metrics communicated to decision-makers",
                                "tool": "rai_executive_summary",
                            },
                        ],
                    },
                    {
                        ...
                        "controls": [
                            {
                                "id": "MG-1.1",
                                "description": "Response plans for identified AI risks documented",
                            },
                            {
                                "id": "MG-2.2",
                                "description": "AI incidents logged and tracked",
                                "tool": "rai_incident_log",
                            },
                            {
                                "id": "MG-3.1",
                                "description": "AI risk responses monitored for effectiveness",
                            },
