...
def upgrade() -> None:
    ...
    # 2. Add web_identity_providers table for OIDC provider linkages
    op.create_table(
    ...
    # 3. Add web_invitations table for tenant invitations
    op.create_table(
        "web_invitations",
        sa.Column("id", sa.String(36), primary_key=True),
    ...
    # 4. Add oauth_flow_states table for durable multi-replica OIDC authorization state
    op.create_table(
        "oauth_flow_states",
    ...
    # 5. Add paddle_webhook_events table for durable replay protection
    op.create_table(
